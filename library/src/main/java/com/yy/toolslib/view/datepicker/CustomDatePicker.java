...
/**
 * Created by Yy on 2018/8/13  013.
 */
...
public class CustomDatePicker {
    ...
    private boolean isShowSpecificTime = false;//是否显示时间（若不显示时间，则仅显示日期）
    ...
    private ImageView cancle_iv, select_iv;

    public CustomDatePicker(Context con, ResultHandler resultHandler, String startDate, String endDate) {
